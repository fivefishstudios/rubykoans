...
class AboutClassMethods < Neo::Koan
  ...
  # I didn't know that... you can add methods to an instance *after* you've 
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    assert_equal nil, Dog.name    # since it's unassigned, value = nil
  end

  # ------------------------------------------------------------------

  class Dog
    def Dog.a_class_method    # note: Classname.methodname
      :dogs_class_method
    end
  end
  ...
  class Dog
    def self.class_method2  # note: self.methodname
  ...
  # this last format is too wordy. I prefer the self.methodname
  class Dog
    class << self     
