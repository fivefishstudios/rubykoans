...
class AboutInheritance < Neo::Koan
  ...
  def test_subclasses_add_new_behavior
    ...
    # Dog class does not have "wag" method, so NameError happens
  ...
  def test_subclasses_can_modify_existing_behavior
    # you can override an existing method in a Class with your own method in your subclass
    # just use the same method name
    chico = Chihuahua.new("Chico")
