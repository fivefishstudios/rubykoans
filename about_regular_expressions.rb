...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/]    # okay, z* means 0 or more characters
                                            # so the only match is "a"
  end
  ...
  def test_character_classes_can_include_ranges
    assert_equal "42", "the number is 42"[/[0-9]+/]   # note, use a dash - 
  end
  ...
  # ------------------------------------------------------------------
  # I DON'T GET ALL OF THESE STUFF BELOW
  # 

  def test_slash_a_anchors_to_the_start_of_the_string
    assert_equal "start", "start end"[/\Astart/]  # I don't get this
    assert_equal nil, "start end"[/\Aend/]
  end

  def test_slash_z_anchors_to_the_end_of_the_string
    assert_equal "end", "start end"[/end\z/]   # I don't get this
    assert_equal nil, "start end"[/start\z/]
  end

  def test_caret_anchors_to_the_start_of_lines
    assert_equal "2", "num 42\n2 lines"[/^\d+/]   # I don't get this
  end

  def test_dollar_sign_anchors_to_the_end_of_lines
    assert_equal "42", "2 lines\nnum 42"[/\d+$/]  # I don't get this
  end
  ...
  def test_a_vertical_pipe_means_or
    ...
    assert_equal "Summer", "Summer Gray"[grays, 1]    # only "Summer" because of "1" parameter
  ...
  def test_sub_is_like_find_and_replace
    assert_equal "one t-three" , "one two-three".sub(/(t\w*)/) { $1[0, 1] } # I don't get this
  end
