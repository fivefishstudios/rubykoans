...
class AboutSandwichCode < Neo::Koan
  ...
  def find_line(file_name)
    ...
    while line = file.gets
      return line if line.match(/e/)    #return line if it contains an "e"
                                        #including the \n character
    end
  ensure
    file.close if file
  ...
  # so basically, we move the open() command into it's own function/method
  # and just yield it's file contents
  # then we use the yielded content (which is the file) in our find_line2 method
  ...
  # Don't get this last code... what's it trying to say?
